...
public class API_TC_596_MATS_Data extends APITestBase {
    ...
    public void test(Map<String, String> map) {
        ...
        String url = "/emissions-mgmt/emissions/apportioned/mats/hourly?api_key="+apikey+"&beginDate=&endDate=&page=1&perPage=1";
        Response response;
...
//      Step 1: Perform a Request on streaming Endpoint with no criteria
    ...
    public void test2(Map<String, String> map) {
        ...
        String url2 = "/emissions-mgmt/emissions/apportioned/mats/hourly?api_key="+apikey+"&beginDate=2020-01-01&endDate=2020-01-02&page=1&perPage=1";
...
//      Step 1: Perform a Request on streaming Endpoint with no criteria
    ...
    public void test3(Map<String, String> map) {
        ...
        String url3 = "/emissions-mgmt/emissions/apportioned/mats/hourly?api_key="+apikey+"&facilityId=invalid&unitType=invalid&unitFuelType=invalid&controlTechnologies=invalid&stateCode=texas&beginDate=2019-01-01&endDate=2019-01-01&page=1&perPage=1";
        Response response;
...
//      Step 1: Perform a Request on streaming Endpoint with no criteria
    ...
    public void test4(Map<String, String> map) {
        ...
        String url = "/emissions-mgmt/emissions/apportioned/mats/hourly?api_key="+apikey+"&beginDate=01-01-2020&endDate=01-02-2020&page=1&perPage=1";
        Response response;
...
//      Step 1: Perform a Request on streaming Endpoint with no criteria
    ...
    public void test5(Map<String, String> map) {
        String apikey = System.getenv("campdAPI");
        String url = "/emissions-mgmt/emissions/apportioned/mats/hourly?api_key="+apikey+"&beginDate=1995-01-01&endDate=2014-01-01&page=1&perPage=1";
        Response response;
        String expectedResult1 = "Update the beginDate to a date between 01/01/2015 and the quarter ending on 06/30/2022";
        String expectedResult2 = "Update the endDate to a date between 01/01/2015 and the quarter ending on 06/30/2022";
...
//      Step 1: Perform a Request on streaming Endpoint with no criteria
    ...
    public void test6(Map<String, String> map) {
        String apikey = System.getenv("campdAPI");
        String url = "/emissions-mgmt/emissions/apportioned/mats/hourly?api_key="+apikey+"&beginDate=2015-01-02&endDate=2015-01-01&page=1&perPage=1";
        Response response;
