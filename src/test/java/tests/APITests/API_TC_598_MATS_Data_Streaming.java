...
public class API_TC_598_MATS_Data_Streaming extends APITestBase {
    ...
    public void test(Map<String, String> map) {
        String url = "/emissions-mgmt/apportioned/mats/hourly/stream?api_key=T8r7OW4f12XtWKLY7CPgKmKu1WoP3TVG0x4eqmlB";
        Response response;
...
//      Step 1: Perform a Request on streaming Endpoint with no criteria
    ...
    public void test2(Map<String, String> map) {
        ...
        String url2 = "/emissions-mgmt/apportioned/mats/hourly/stream?api_key=T8r7OW4f12XtWKLY7CPgKmKu1WoP3TVG0x4eqmlB&beginDate=2020-01-01&endDate=2020-01-02";
...
//      Step 1: Perform a Request on streaming Endpoint with no criteria
    ...
    public void test4(Map<String, String> map) {
        String url = "/emissions-mgmt/apportioned/mats/hourly/stream?api_key=T8r7OW4f12XtWKLY7CPgKmKu1WoP3TVG0x4eqmlB&beginDate=01-01-2020&endDate=01-02-2020";
        Response response;
...
//      Step 1: Perform a Request on streaming Endpoint with no criteria
    ...
    public void test5(Map<String, String> map) {
        String url = "/emissions-mgmt/apportioned/mats/hourly/stream?api_key=T8r7OW4f12XtWKLY7CPgKmKu1WoP3TVG0x4eqmlB&beginDate=1995-01-01&endDate=2014-01-01";
        Response response;
...
//      Step 1: Perform a Request on streaming Endpoint with no criteria
    ...
    public void test6(Map<String, String> map) {
        String url = "/emissions-mgmt/apportioned/mats/hourly/stream?api_key=T8r7OW4f12XtWKLY7CPgKmKu1WoP3TVG0x4eqmlB&beginDate=2015-01-02&endDate=2015-01-01";
        Response response;
