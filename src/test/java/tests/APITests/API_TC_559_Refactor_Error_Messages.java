...
public class API_TC_559_Refactor_Error_Messages extends APITestBase {
    ...
    public void test3(Map<String, String> map) {
        String url = "/emissions-mgmt/apportioned/mats/monthly?api_key=" + apikey + "&facilityId=invalid&unitType=invalid&unitFuelType=invalid&controlTechnologies=invalid&stateCode=texas&beginDate=2019-01-01&endDate=2019-01-01";
        Response response;
        String expectedResult1 = "One or more stateCodes are not valid. Use the two letter postal abbreviation (use TX, not Texas)";
        String expectedResult2 = "One or more facilityIds are not valid. Refer to the list of available facilityIds for valid values https://api.epa.gov/easey/dev/facilities-mgmt/facilities";
        String expectedResult3 = "One or more unitTypes are not valid. Refer to the list of available unitTypes for valid values https://api.epa.gov/easey/dev/master-data-mgmt/unit-types";
    ...
    public void test4(Map<String, String> map) {
        String url = "/emissions-mgmt/apportioned/mats/quarterly?api_key="  + apikey + "&facilityId=invalid&unitType=invalid&unitFuelType=invalid&controlTechnologies=invalid&stateCode=texas&beginDate=2019-01-01&endDate=2019-01-01";
        Response response;
        String expectedResult1 = "One or more stateCodes are not valid. Use the two letter postal abbreviation (use TX, not Texas)";
        String expectedResult2 = "One or more facilityIds are not valid. Refer to the list of available facilityIds for valid values https://api.epa.gov/easey/dev/facilities-mgmt/facilities";
        String expectedResult3 = "One or more unitTypes are not valid. Refer to the list of available unitTypes for valid values https://api.epa.gov/easey/dev/master-data-mgmt/unit-types";
    ...
    public void test5(Map<String, String> map) {
        String url = "/emissions-mgmt/apportioned/mats/annual?api_key="  + apikey + "&facilityId=invalid&unitType=invalid&unitFuelType=invalid&controlTechnologies=invalid&stateCode=texas&beginDate=2019-01-01&endDate=2019-01-01";
        Response response;
        String expectedResult1 = "One or more stateCodes are not valid. Use the two letter postal abbreviation (use TX, not Texas)";
        String expectedResult2 = "One or more facilityIds are not valid. Refer to the list of available facilityIds for valid values https://api.epa.gov/easey/dev/facilities-mgmt/facilities";
        String expectedResult3 = "One or more unitTypes are not valid. Refer to the list of available unitTypes for valid values https://api.epa.gov/easey/dev/master-data-mgmt/unit-types";
    ...
    public void test6(Map<String, String> map) {
        String url = "/emissions-mgmt/apportioned/mats/ozone?api_key=" + apikey + "&facilityId=invalid&unitType=invalid&unitFuelType=invalid&controlTechnologies=invalid&stateCode=texas&beginDate=2019-01-01&endDate=2019-01-01";
        Response response;
        String expectedResult1 = "One or more stateCodes are not valid. Use the two letter postal abbreviation (use TX, not Texas)";
        String expectedResult2 = "One or more facilityIds are not valid. Refer to the list of available facilityIds for valid values https://api.epa.gov/easey/dev/facilities-mgmt/facilities";
        String expectedResult3 = "One or more unitTypes are not valid. Refer to the list of available unitTypes for valid values https://api.epa.gov/easey/dev/master-data-mgmt/unit-types";
    ...
    public void test7(Map<String, String> map) {
        String url = "/account-mgmt/allowance-holdings?api_key="  + apikey + "&page=1&perPage=1&accountType=&accountNumber=0&facilityId=0&stateCode=&vintageYear=0&ownerOperator=0&programCodeInfo=";
        Response response;
        String expectedResult1 = "One or more stateCodes are not valid. Use the two letter postal abbreviation (use TX, not Texas)";
        String expectedResult2 = "One or more facilityIds are not valid. Refer to the list of available facilityIds for valid values https://api.epa.gov/easey/dev/facilities-mgmt/facilities";
