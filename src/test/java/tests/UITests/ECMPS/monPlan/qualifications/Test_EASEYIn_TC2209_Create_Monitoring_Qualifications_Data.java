...
public class Test_EASEYIn_TC2209_Create_Monitoring_Qualifications_Data extends UiReusableComponents {
    ...
    public void tests() throws InterruptedException {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);",
                monitoringPlansPage.createQualificationButton);

        int numOfQualifications = monitoringPlansPage.viewButton.size();

        click(monitoringPlansPage.createQualificationButton);

        waitFor(monitoringPlansPage.monPlanModalHeaderLabel);
        verifyEquals(monitoringPlansPage.monPlanModalHeaderLabel, "Create Qualification");
        ...
        int newNumOfQualifications = monitoringPlansPage.viewButton.size();

        verifyTrue(newNumOfQualifications == numOfQualifications + 1);
