package tests.UITests.ECMPS.monPlan.qualifications;
...
public class Test_EASEYIn_TC2208_Edit_Monitoring_Qualifications_Data extends UiReusableComponents {
    ...
    public void tests() throws InterruptedException {
        ...
        String qualificationTypeCode = monitoringPlansPage.qualificationTypeCodeField.get(0).getText();
        ...
        waitFor(monitoringPlansPage.qualificationTypeCodeModalDropdown);
        if (qualificationTypeCode.equals("PK")) {
            click(monitoringPlansPage.qualificationTypeCodeModalDropdown.get(2));
        } else {
            click(monitoringPlansPage.qualificationTypeCodeModalDropdown.get(4));
        }
        ...
        verifyNotEquals(monitoringPlansPage.monMethodsTableParameterField.get(0).getText(), qualificationTypeCode);
        ...
        Thread.sleep(3000);
        waitFor(monitoringPlansPage.qualificationTypeCodeField.get(0));
        verifyEquals(monitoringPlansPage.qualificationTypeCodeField.get(0).getText(), qualificationTypeCode);
