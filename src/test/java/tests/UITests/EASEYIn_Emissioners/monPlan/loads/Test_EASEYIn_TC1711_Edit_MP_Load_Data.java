...
public class Test_EASEYIn_TC1711_Edit_MP_Load_Data extends UITestBase {
...
//        action.moveToElement(monitoringPlansPage.saveCloseModal).click().build().perform();
        System.out.println(monitoringPlansPage.saveCloseModal.isDisplayed());
        System.out.println(monitoringPlansPage.saveCloseModal.isEnabled());
...
//        action.moveToElement(monitoringPlansPage.configcheckBackInButton).click().build().perform();
        js.executeScript("arguments[0].click();", monitoringPlansPage.configcheckBackInButton);
        waitFor(monitoringPlansPage.configcheckOutButton);
        verifyEquals(monitoringPlansPage.configcheckOutButton, "Check Out");

        // Closing tab
        js.executeScript("arguments[0].scrollIntoView(true);",
                monitoringPlansPage.closeConfigTab);
