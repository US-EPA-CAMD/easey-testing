...
public class test_EASEY_QaInjectionCreateLocal extends CommonExport {
    ...
    public void test() throws InterruptedException {
        ...
        //wait for drop down
        waitFor(qaCertificationPage.injectionOption);
        //select "Calibration Injection" from drop down
        click(qaCertificationPage.injectionOption);
